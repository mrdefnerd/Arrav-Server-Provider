...
public class Injector implements Opcodes {
	...
	public static void injectPaint() {
		new AddGetterAdapter(ASMUtils.getClass("GZ"),
				ASMUtils.getField(ASMUtils.getClass("GZ"),
"drawImage"), "getImage").inject();

		ClassNode cg = ASMUtils.getClass("GZ");
		...
		for (MethodNode m : cg.methods) {
			...
			if (m.name.equals("I")
				...
				inject.add(new FieldInsnNode(GETFIELD, cg.name, "drawImage",
						"Ljava/awt/Image;"));
