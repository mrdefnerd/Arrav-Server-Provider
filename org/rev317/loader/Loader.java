 ...
 *
 */
@ServerManifest(author = "Demmonic", name = "Arrav", type = Type.INJECTION, version = 0.1)
public class Loader extends ServerProvider implements Opcodes {
	...
	public URL getJar() {
		try {
			...
			return new URL("http://data.arravrsps.com/arravclient.jar");
	...
	public URL getHooks() {
		try {
			...
			return new URL("https://dl.dropboxusercontent.com/u/83439509/317hooks.xml");
		} catch (MalformedURLException e) {
			throw new RuntimeException(e);
		}
	}
